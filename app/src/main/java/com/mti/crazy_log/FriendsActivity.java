...
public class FriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissions.contains("user_friends")) {
            ...
            // prompt user to grant permissions as for accessing friends list we need permission
    ...
    private void fetchFriends() {
        ...
        parameters.putString("fields", "id,name,picture,birthday");
                    ...
                    public void onCompleted(GraphResponse response) {
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonData.length(); i++) {
                                ...
                                String name = jsonUser.getString("birthday");
